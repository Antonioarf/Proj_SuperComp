...
//         vector<int> lim0 = lim;
//         lim0[filmes[0].cat]-=1;
//         result rec = knapSack(f0.comeco,lim0, filmes);
//         rec.horas += (f0.fim - f0.comeco);
//         rec.quant +=1; 
//         return maximo(rec, knapSack(horario,lim, filmes));
//     }
// }
...
//             if (filmes[i].fim <= horario && lim[filmes[i].cat] > 0) {
//                 filme f0 = filmes[i];
//                 vector<int> lim0 = lim;
//                 lim0[filmes[i].cat] -= 1;
//                 result rec = knapSack(f0.comeco,lim0, filmes);
...
//                 #pragma omp critical
//                 {
//                     best_result = maximo(best_result, rec);
//                 }
//             }
//         }
//         return best_result;
